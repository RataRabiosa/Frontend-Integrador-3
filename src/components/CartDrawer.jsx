...
const CartTable = () => {
    // Desestructurar el estado y la función del drawer desde las props
...
const { token } = UserAuth();
    ...
    return (
      <div className="menu bg-base-200 min-h-full w-100 p-4">
        <h2 className="font-bold text-lg mb-4">Carrito de Compras</h2>
        {
          totalCartItems() > 0 
          ?
          <>
                      ...
                      <tr key={item.id}>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="font-bold">
                                <p>{item.name}</p>
                                <button className="btn text-blue-300" onClick={() => {
                        ...
                        <td>
                          <div className="flex space-x-2">
                            <button className="btn btn-sm" onClick={() => decreaseItem(item.id)}>-</button>
                            <span className="ml-2 mr-4 mt-1">{item.quantity}</span>
